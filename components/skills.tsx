        ...
        {skilss.map((skill, index) => (
          <div key={index} className="relative mt-5 flex justify-center">
            <motion.div
              ...
              className="relative flex justify-center md:w-[144px] w-[70px] md:h-[140px] h-[71px] rounded-md bg-white dark:bg-[#232D3F] md:p-5 p-3 shadow-[8px_8px_0_0_#334155] dark:shadow-[8px_8px_0_0_#334155] dark:hover:shadow-[15px_15px_0_0_#334155] hover:shadow-[15px_15px_0_0_#334155] transition-shadow"
            >
              <Image
                src={skill.imgUrl}
