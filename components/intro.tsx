...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Afiv Dicky Efendy.</span>
      </motion.h1>
      <motion.h4
        ...
        animate={{ opacity: 1, y: 0 }}
      >
        <span className="font-bold">3 years</span> of experience in Mobile app
        development, using <span className="font-bold">Flutter and Kotlin</span>{" "}
        for developing a mobile applications.
      ...
      >
        ...
        <a
          ...
          href="/cv/Resume_Afiv_Dec_2024.pdf"
          download
        >
          Download CV{" "}
      ...
      >
        <a
          ...
          href="https://www.linkedin.com/in/haonlabs/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="mailto:dickyareda@gmail.com"
          target="_blank"
        >
          <RiMailSendLine />
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://github.com/haonlabs"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://www.instagram.com/haonlabs_/"
          target="_blank"
        >
          <BsInstagram />
        </a>
